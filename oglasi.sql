...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2018 at 11:52 PM
...
INSERT INTO `korisnici` (`id`, `username`, `password`, `isAdmin`) VALUES
(1, 'root', 'rootpass', 1),
(3, 'fico', 'ubitornjaka', 0),
(4, 'a', 'a', 1),
(5, 'b', 'b', 0);
...
(23, 'Mj', '123', 'TV', 'ADMNIASOIDN', '1234.00', './userimg/59c87f09a437529e7c67a4d461619e9a33073c90.jpg', 0);
